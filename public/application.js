...
/***/ (function(module, exports, __webpack_require__) {
	...
	var homeEvents = __webpack_require__(7);
	var appEvents = __webpack_require__(34);
	var listEvents = __webpack_require__(9);
	// require('./example')
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onLearnMore = function onLearnMore() {
	  event.preventDefault();
	  ui.learnMore();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var appApi = __webpack_require__(10);
	var appUi = __webpack_require__(12);
	var app = __webpack_require__(11);
	var getFormFields = __webpack_require__(33);

	// onGetevent to show all user events
	var onGetEvents = function onGetEvents(event) {
	  console.log('hi');
	  event.preventDefault();
	  appApi.showEvent(event).then(appUi.onSuccessGetEvent).catch(appUi.onFailureGetEvent);
	};
	...
	// post
	var onCreateNewEvent = function onCreateNewEvent() {
	  var data = getFormFields(this);
	  console.log('create');
	  event.preventDefault();
	  appApi.newEvent(data).then(appUi.newSuccess).then(function () {
	    $("#eventsShow").click();
	  }).catch(appUi.newFail);
	};

	var onDeleteEvent = function onDeleteEvent(data) {
	  //$('#deleteEvent').val(my_id)
	  var delete_id = $(this).attr('data-id');
	  console.log(delete_id);
	  event.preventDefault();
	  appApi.deleteEvent(delete_id).then(appUi.deleteSuccess).then(function () {
	    $("#eventsShow").click();
	...
	var updateEvent = function updateEvent(event) {
	  ...
	  var update_id = data.event.event_id;
	  console.log('update bbb');
	  event.preventDefault();
	  appApi.updateEvent(data, update_id).then(appUi.onUpdateSuccess).then(function () {
	    $("#eventsShow").click();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// this shows my data
	var showEvent = function showEvent(id) {
	  return $.ajax({
	    url: app.host + '/events/',
	    method: 'GET',
	    headers: {
	...
	// add in other files
	var deleteEvent = function deleteEvent(delete_id) {
	  // console.log('happy')
	  // console.log(delete_id)
	  return $.ajax({
	...
	var updateEvent = function updateEvent(data, update_id) {
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  host: 'https://blooming-stream-25969.herokuapp.com/'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSuccessGetEvent = function onSuccessGetEvent(data) {
	  $('.list-header').show();
	  $('.list-header').empty();
	  $('.list').empty();
	  console.log('this is the success function in ui');
	  var events = data.events;
	  var my_id = data.events.id;
	  console.log(events);
	  // console.log(id)
	  var context = {
	    'events': data.events,
	  ...
	  };var allItems = __webpack_require__(13);
	  var listTemplateFilled = allItems(context);
	...
	var onFailureGetUserEvent = function onFailureGetUserEvent(data) {}
	// console.log('failure')


	// get all events
	;var getAllEvents = function getAllEvents(data) {}
	// app.user.events = data.events


	// CREATE New EVENT
	;var newSuccess = function newSuccess() {
	  // $('.list').empty()
	  // $('.list-header').empty()
	  $('#create-event').hide();
	  console.log('success');
	...
	;module.exports = {
	  onSuccessGetEvent: onSuccessGetEvent,
	  // onSuccessGetUserEvent,
	  onFailureGetUserEvent: onFailureGetUserEvent,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.events : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	  ...
	  return "               <li data-id=\""
	    ...
	    + "\" "
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.packed : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "><input type=\"checkbox\" "
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.packed : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + " class=\"pack-content\"> "
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "\n               <a href=\"\" class=\"deleteEvent\" data-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    ...
	    return "              <p>Start your list.</p>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"listview\">\n  <div class=\"list-header\">\n\n        <h3>Todo List<a id=\"createEventButton\" title=\"Create a list\" role=\"button\">       <i class=\"fa fa-plus-square\" aria-hidden=\"true\"></i></a></h3>\n\n</div>\n\n\n<div class=\"list\">\n        <!-- <button type=\"Submit\" id='eventsShow' class=\"btn btn-info\">View list >></button> -->\n\n          <ul>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.events : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
	    + "          </ul>\n    </div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var appApi = __webpack_require__(35);
	var appUi = __webpack_require__(36);
	var app = __webpack_require__(11);
	var getFormFields = __webpack_require__(33);
	...
	var registerUser = function registerUser(event) {
	  ...
	  if (data.credentials.password !== data.credentials.password_confirmation) {
	    ...
	    appApi.addUser(data).then(appUi.onSignupSuccess).catch(appUi.onSignupFailure);
	  }
	};
	...
	var loginUser = function loginUser(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  appApi.userLogin(data).then(appUi.onSigninSuccess).then(function () {
	    $('#eventsShow').click();
	  }).catch(appUi.onSigninFailure);
	};

	var logoutUser = function logoutUser(event) {
	  // const data = getFormFields(this)
	  event.preventDefault();
	  appApi.userLogout().then(appUi.onLogoutSuccess).catch(appUi.onLogoutFailure);
	};

	var resetPassword = function resetPassword(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  appApi.passwordReset(data).then(appUi.onResetSuccess).catch(appUi.onResetFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userLogout = function userLogout(id) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSigninSuccess = function onSigninSuccess(data) {
	  app.user = data.user;
	  var user = app.user;
	  var userProfile = __webpack_require__(38);
	  $('.view').html(userProfile(user));
	  $('.view').show();
	  $('#log-out').show();
	  $('.home').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"home\">\n<div class=\"welcome\">\n  <!-- <div class=\"jumbotron\"> -->\n\n        <div class=\"container\">\n\n          <div id=\"errorMessage\"></div>\n          <div id=\"yayMessage\"></div>\n          <div id=\"changePasswordMessage\"></div>\n          <div id=\"begin\"></div>\n\n\n\n\n          <h1> Planning site for the wedding party!</h1>\n\n\n\n          <div class=\"row\">\n            <div class=\"col-md-9 push-md-3 offset-md-3\">  <form id=\"registration\" class=\"form-signin\">\n            <h3>Register</h3>\n\n            <div class=\"input-group\">\n                <label for=\"password\"> Email </label>\n              <input type=\"text\" class=\"form-control\" name=\"credentials[email]\" placeholder=\"Email\" aria-label=\"Username\" aria-describedby=\"sizing-addon2\">\n            </div>\n            <div class=\"input-group\">\n            <label for=\"password\"> Password </label>\n            <input type=\"password\" class=\"form-control\" name=\"credentials[password]\" placeholder=\"Password\">\n            </div>\n            <div class=\"input-group\">\n            <label for=\"password-confirm\"> Password </label>\n            <input type=\"password\" class=\"form-control\" name=\"credentials[password_confirmation]\" placeholder=\"Confirm Password\">\n            </div>\n            <br>\n            <input type=\"submit\" class=\"btn btn-info\" name=\"submit\" value=\"Register\">\n\n\n          </form>\n        </div>\n\n            <div class=\"col-md-3 pull-md-9\"><form id=\"login\" class=\"form-signin\">\n              <h3> Login</h3>\n              <div class=\"input-group\">\n                <label for=\"username\"> Username </label>\n                <input type=\"text\" class=\"form-control\" name=\"credentials[email]\" placeholder=\"Email\">\n              </div>\n              <div class=\"input-group\">\n                <label for=\"password\"> Password </label>\n                <input type=\"password\" class=\"form-control\" name=\"credentials[password]\" placeholder=\"Password\">\n              </div>\n              <br>\n              <input type=\"submit\" name=\"submit\" class=\"btn btn-info\" value=\"Log In\">\n            </form>\n</div>\n          </div>\n\n</div>\n</div>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"user-info\">\n<input type=\"hidden\" id='eventsShow' class=\"btn btn-info\"></input>\n  </div>\n";
	},"useData":true});
